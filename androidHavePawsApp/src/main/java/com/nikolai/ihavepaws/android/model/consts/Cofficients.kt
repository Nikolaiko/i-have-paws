...
const val topTitleLeadingPadding = topBarTitleLeadingPadding
const val topTitleBottomPadding = topBarTitleBottomPadding

const val groupRowVerticalPadding = groupItemRowInsideVerticalPadding.toFloat()
const val groupRowHorizontalPadding = groupItemRowInsideHorizontalPadding.toFloat()
const val groupHeightCoff = groupRowHeightCoff.toFloat()
const val groupWidthCoff = groupRowWidthCoff.toFloat()
const val groupVertSpacing = groupRowVerticalSpacingCoff.toFloat()
const val groupCornerRadius = groupRowRoundCoff.toFloat()

const val addDialogWidthCoff = 0.9f
const val addDialogHeightCoff = 0.9f

const val toggleButtonPaddingCoff = 0.03f
const val toggleButtonHeightCoff = 0.3f

const val randomButtonSizeCoof = 0.1f
const val randomButtonPaddingCoof = 0.05f
